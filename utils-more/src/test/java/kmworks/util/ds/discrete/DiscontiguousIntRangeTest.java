...
public class DiscontiguousIntRangeTest {
    ...
    public void testContains() {
        AbstractIntRange range = DiscontiguousIntRange.of(new DiscontiguousIntRange.Builder()
                .addRange(10, 20)
                .add(30)
                .addRange(40, 50)
                .build());
    ...
    public void testIndexOf() {
        AbstractIntRange range = DiscontiguousIntRange.of(new DiscontiguousIntRange.Builder()
                ...
                .addRange(40, 50)
                .build());
        assertTrue(0 == range.indexOf(10));
        assertTrue(10 == range.indexOf(20));
        assertTrue(11 == range.indexOf(30));
        assertTrue(12 == range.indexOf(40));
    }
