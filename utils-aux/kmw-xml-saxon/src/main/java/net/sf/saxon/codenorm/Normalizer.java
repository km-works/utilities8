...
public class Normalizer {
    ...
    */
     ...
     * @return the modified target StringBuilder
    */
    private StringBuilder normalize(CharSequence source, StringBuilder target) {
    ...
    */
    public CharSequence normalize(CharSequence source) {
        return normalize(source, new StringBuilder(source.length()+8));
    }
...
//    *                      the recursive canonical decomposition.
    ...
    * @param   target      the resulting normalized text
    */
    private void internalDecompose(CharSequence source, StringBuilder target) {
...
//                    }
    ...
    */
     ...
     * @param target the StringBuilder in which the data is to be inserted
    ...
    private static void setCharAt(StringBuilder target, int offset, int ch32) {
        if (ch32 < 65536) {
