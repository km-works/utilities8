...
public class ParseOptions {
     ...
     * @param model one of {@link net.sf.saxon.event.Builder#TINY_TREE} or
     * {@link net.sf.saxon.event.Builder#LINKED_TREE}
     */
     ...
     * @return one of {@link net.sf.saxon.event.Builder#TINY_TREE} or {@link net.sf.saxon.event.Builder#LINKED_TREE},
