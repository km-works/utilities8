 ...
 * class. If the property is not defined, a platform default is used.</p>
 *
...
public class TransformerFactoryImpl extends SAXTransformerFactory {
    ...
    */
     ...
     * @return true if DOM processing is available, that is, if the class net.sf.saxon.dom.DOMObjectModel
