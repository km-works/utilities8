...
//
// Portions created by Christian P. Lerch are Copyright (C) 2017 Christian P. Lerch. All Rights Reserved.
//  - Java 8 syntax code modernization and JavaDoc corrections
//
// Contributor(s): none.
*/
 ...
 * services needed for schema-aware processing. The class com.saxonica.validate.SchemaAwareConfiguration
...
//        System.err.println(platform.getClass().getName());
     ...
     * be encountered.
     * 
     * <p>This method is problematic because it is possible to run multiple transformations
     ...
     * no differences when used for static errors, the choice is immaterial.</p>
     *
...
//    }
     ...
     * {@link net.sf.saxon.functions.JavaExtensionLibrary}. It thus disables the function libraries
     ...
     *         will always be a {@link net.sf.saxon.functions.JavaExtensionFunctionFactory} in the case of the Java platform,
     *         or a <code>net.sf.saxon.dotnet.DotNetExtensionFunctionFactory</code> on the .NET platform
     */
     ...
     *                always be a {@link net.sf.saxon.functions.JavaExtensionFunctionFactory} for the "java" scheme,
     *                or a <code>net.sf.saxon.dotnet.DotNetExtensionFunctionFactory</code> for the "clitype" scheme
     ...
     *                                  <strong>not</strong> call the registered {@link SourceResolver to resolve the Source}.
     */

    public NodeInfo unravel(Source source) {
        List extObjectModels = getExternalObjectModels();
        for (int m = 0; m < extObjectModels.size(); m++) {
            ExternalObjectModel model = (ExternalObjectModel)extObjectModels.get(m);
     ...
     *               in a Saxon {@link net.sf.saxon.dom.DocumentWrapper}, except in the case where the DOM Document node
     *               is a {@link net.sf.saxon.dom.DocumentOverNodeInfo}, in which case the DocumentInfo that it wraps is
     *               returned.</li>
    ...
    public DocumentInfo buildDocument(Source source) throws XPathException {
        ...
        if (!mustCopy) {
            ...
            if (source instanceof AugmentedSource) {
                ...
                if (underSource instanceof DocumentInfo || underSource instanceof DOMSource) {
                    boolean wrap = asource.getWrapDocument() == null || asource.getWrapDocument();
        ...
        Builder b;
        int aTreeModel = Builder.UNSPECIFIED_TREE_MODEL;
        if (source instanceof AugmentedSource) {
            aTreeModel = ((AugmentedSource)source).getTreeModel();
        }

        if (aTreeModel == Builder.UNSPECIFIED_TREE_MODEL) {
            aTreeModel = this.treeModel;
        }
        if (aTreeModel == Builder.TINY_TREE) {
            b = new TinyBuilder();
        } else {
            b = new TreeBuilder();
        }
        ...
        boolean aLineNumbering = this.lineNumbering;
        if (source instanceof AugmentedSource && ((AugmentedSource)source).isLineNumberingSet()) {
            aLineNumbering = ((AugmentedSource)source).isLineNumbering();
        }
        b.setLineNumbering(aLineNumbering);
    ...
    public void setConfigurationProperty(String name, Object value) {
        ...
        switch (name) {
            ...
            case FeatureKeys.COLLATION_URI_RESOLVER:
                ...
                break;
            case FeatureKeys.COLLATION_URI_RESOLVER_CLASS:
            ...
            case FeatureKeys.COLLECTION_URI_RESOLVER:
                ...
                break;
            case FeatureKeys.COLLECTION_URI_RESOLVER_CLASS:
                if (!(value instanceof String)) {
                    throw new IllegalArgumentException(
            ...
            case FeatureKeys.MODULE_URI_RESOLVER:
                ...
                break;
            case FeatureKeys.MODULE_URI_RESOLVER_CLASS:
                if (!(value instanceof String)) {
                    throw new IllegalArgumentException(
            ...
            case FeatureKeys.NAME_POOL:
                ...
                break;
            case FeatureKeys.OUTPUT_URI_RESOLVER:
                ...
                break;
            case FeatureKeys.OUTPUT_URI_RESOLVER_CLASS:
                if (!(value instanceof String)) {
                    throw new IllegalArgumentException(
            ...
            case FeatureKeys.RECOVERY_POLICY_NAME:
                ...
                break;
            case FeatureKeys.SCHEMA_URI_RESOLVER:
                ...
                break;
            case FeatureKeys.SCHEMA_URI_RESOLVER_CLASS:
                if (!(value instanceof String)) {
                    throw new IllegalArgumentException(
