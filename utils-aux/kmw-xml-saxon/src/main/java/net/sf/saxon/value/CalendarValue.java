...
public abstract class CalendarValue extends AtomicValue {
   ...
   /**
    ...
    public static void appendTimezone(int tz, StringBuilder sb) {
        if (tz == 0) {
            sb.append("Z");
        } else {
            sb.append(tz > 0 ? "+" : "-");
    ...
    static void appendString(StringBuilder sb, int value, int size) {
...
/**
    ...
    static void appendTwoDigits(StringBuilder sb, int value) {
