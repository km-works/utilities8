...
public class AttributeTypeTest extends XOMTestCase {
    ...
    public void testEquals() {
        ...
        assertFalse(Attribute.Type.CDATA.equals(1));
    ...
    public void testGetName() {
        ...
        assertEquals("ENUMERATION", Attribute.Type.ENUMERATION.name());
        assertEquals("NOTATION", Attribute.Type.NOTATION.name());
        assertEquals("ENTITY", Attribute.Type.ENTITY.name());
        assertEquals("ENTITIES", Attribute.Type.ENTITIES.name());
        assertEquals("CDATA", Attribute.Type.CDATA.name());
        assertEquals("ID", Attribute.Type.ID.name());
        assertEquals("IDREF", Attribute.Type.IDREF.name());
        assertEquals("IDREFS", Attribute.Type.IDREFS.name());
        assertEquals("NMTOKEN", Attribute.Type.NMTOKEN.name());
        assertEquals("NMTOKENS", Attribute.Type.NMTOKENS.name());
    }
