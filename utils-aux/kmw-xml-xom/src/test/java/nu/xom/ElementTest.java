...
public class ElementTest extends XOMTestCase {
    ...
    public void testToXML2() throws ParsingException, IOException {
        ...
        File f = new File(XOMTestSuite.TEST_DATA_DIR);
   ...
   public void testInsertChildNegative() {
    ...
    public void testXMLNamespace() {
        ...
        String xmlNamespace = Namespace.XML_NAMESPACE;
    ...
    public void testXMLPrefixOnElement() {
        Element e = new Element("xml:test", Namespace.XML_NAMESPACE);
    ...
    public void testXMLPrefixAllowed() {
        ...
        assertEquals(Namespace.XML_NAMESPACE, test.getNamespaceURI());
    ...
    public void testWrongPrefixNotAllowedWithXMLURI() {
        ...
        try {
            new Element("test:base", Namespace.XML_NAMESPACE);
