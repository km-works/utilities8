...
public class NodeFactoryTest extends XOMTestCase {
    ...
    private final File dataDir = new File(XOMTestSuite.TEST_DATA_DIR);
    
    
    public NodeFactoryTest(String name) {
        super(name);
        if (!dataDir.exists()) throw new RuntimeException("test data directory not found");
    }
    ...
    public void testMinimalizedDocument() 
      throws IOException, ParsingException {
        ...
        File input = new File(dataDir, "entitytest.xml");
    ...
    public void testDontReportCommentsAndProcessingInstructionsInExternalDTDSubset() 
      throws IOException, ParsingException {
        ...
        File input = new File(dataDir, "contentindtd.xml");
