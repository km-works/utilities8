...
<template match="magazine[@style='glossy']" priority="-1">
...
<template match="my:book/my:title" priority="0.6">
...
<my:br/><apply-templates/>
  ...
  <template match="my:magazine" priority="0.6">
...
<template match="book/price" priority = "-30000">
	<my:SPAN style="color=red" >
<value-of select="name()"/>: <value-of select="."/> </my:SPAN>
<my:br/><apply-templates/>
  </template>
...
<template match="book/price" priority = "-3">
