...
public class Element extends ParentNode {
    ...
    private static void copyChildren(final Element sourceElement, Element resultElement) {
    ...
    public void addAttribute(Attribute attribute) {
        ...
        Attribute oldAttribute = getAttribute(attribute.getLocalName(), attribute.getNamespaceURI());
     ...
     * @throws NamespaceConflictException if this element has a prefix 
    ...
    private void _setNamespaceURI(String uri) {
        ...
        if (Namespace.XML_NAMESPACE.equals(uri) 
          && ! "xml".equals(prefix)) {
            throw new NamespaceConflictException(
              "Wrong prefix " + prefix + 
    ...
    public void addNamespaceDeclaration(String prefix, String uri) {
        ...
        if (prefix.equals("xmlns")) {
            ...
            if (uri.equals(Namespace.XML_NAMESPACE)) {
                // This is done automatically
                return; 
            }
            throw new NamespaceConflictException(
