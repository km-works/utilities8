...
public final class XSLTransform {
     ...
     */ 
     private XSLTransform(Source source) throws XSLException {
        ...
        try {
            ...
            this._templates = factory.newTemplates(source);
        }
    ...
    public XSLTransform(Document stylesheet, NodeFactory factory) 
      throws XSLException {
        ...
        if (factory == null) this._factory = new NodeFactory(); 
    ...
    private Nodes transform(Source in) throws XSLException {
        ...
        try {
            XOMResult out = new XOMResult(_factory);
    ...
    public String toString() {
        return "[" + getClass().getName() + ": " + _templates + "]";   
    }
