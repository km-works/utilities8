...
public class Translator {
  ...
  static abstract class CharClass  {
    ...
    final void outputMungeSurrogates(StringBuilder buf) {
    ...
    abstract void outputDirect(StringBuilder buf);
    abstract void outputComplementDirect(StringBuilder buf);
  ...
  static abstract class SimpleCharClass extends CharClass {
    ...
    void outputDirect(StringBuilder buf) {
      buf.append('[');
    ...
    void outputComplementDirect(StringBuilder buf) {
    ...
    abstract void inClassOutputDirect(StringBuilder buf);

    static void outputWide(StringBuilder buf, int c) {
  ...
  static class SingleChar extends SimpleCharClass {
    ...
    void inClassOutputDirect(StringBuilder buf) {
      if (isJavaMetaChar(c))
        buf.append('\\');
      buf.append(c);
    }
