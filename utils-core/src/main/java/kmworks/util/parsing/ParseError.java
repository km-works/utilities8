 ...
 */
public final class ParseError extends ParseResult {

  /**
   * The default parse error.  It is used for
   ...
   */
  public static final ParseError DEFAULT = new ParseError("default parse error", -1);
  ...
  public <T> T semanticValue() {
    throw new UnsupportedOperationException("ParseError cannot have a semantic value");
  }
  ...
  public ParseError confine(final ParseError other) {
   ...
   */
  public ParseError confine(final String msg, final int index) {
  ...
  public SemanticValue createValue(final Object value, final ParseError error) {
    throw new UnsupportedOperationException("We are a ParseError");
  }
