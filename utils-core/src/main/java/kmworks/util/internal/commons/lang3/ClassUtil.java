...
public class ClassUtil {
    ...
    public static String getAbbreviatedName(String className, int len) {
      ...
      int packageLevels = StringUtil.countOccurencesOf(className, ".");
      ...
      return Joiner.on(".").join(output); //StringUtils.join(output, '.');
    }
    ...
    public static boolean isAssignable(final Class<?>[] classArray, final Class<?>... toClassArray) {
        return isAssignable(classArray, toClassArray, true);    //SystemUtils.isJavaVersionAtLeast(JavaVersion.JAVA_1_5)
    }
    ...
    public static boolean isAssignable(final Class<?> cls, final Class<?> toClass) {
        return isAssignable(cls, toClass, true);   //SystemUtils.isJavaVersionAtLeast(JavaVersion.JAVA_1_5))
    }
