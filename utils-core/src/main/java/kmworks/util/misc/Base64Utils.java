/*
 * Copyright (C) 2014 Christian P. Lerch <christian.p.lerch[at]gmail.com>
 *
...
public class Base64Utils
{
	...
	/** Decodes a BASE64 encoded <code>String</code>. All illegal characters will be ignored. Can handle both strings with
